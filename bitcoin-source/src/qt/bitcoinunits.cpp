...
{
    switch (unit) {
    case Unit::BTC: return QString("SHC");
    case Unit::mBTC: return QString("mSHC");
    case Unit::uBTC: return QString::fromUtf8("µSHC (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Sharecoin");
    case Unit::mBTC: return QString("Milli-Sharecoin (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Sharecoin (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
